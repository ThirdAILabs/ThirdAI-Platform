...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('unique_workflow_model_component', 'workflow_models', type_='unique')
    ...
    sa.ForeignKeyConstraint(['model_id'], ['models.id'], name='logs_model_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='logs_user_id_fkey', ondelete='CASCADE'),
